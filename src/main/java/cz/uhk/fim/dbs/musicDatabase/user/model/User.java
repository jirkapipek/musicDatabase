package cz.uhk.fim.dbs.musicDatabase.user.model;
...
public class User {
    ...
    public User(String firstName, String lastName, String email, String password, List<Article> articles, Collection<Role> roles) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.email = email;
        this.password = password;
